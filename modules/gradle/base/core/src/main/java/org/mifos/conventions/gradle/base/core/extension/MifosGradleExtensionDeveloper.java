...
public abstract class MifosGradleExtensionDeveloper implements Named {
    private final String name;

    public MifosGradleExtensionDeveloper() {
        this(null);
    }

    @Inject
    public MifosGradleExtensionDeveloper(String name) {
        this.name = name;
